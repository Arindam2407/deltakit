...
class StimNoise(
    ...
    def __init__(
        self,
        before_gate_noise_profile: Optional[
            sp.NoiseProfile | Iterable[sp.NoiseProfile]
        ] = None,
        after_gate_noise_profile: Optional[
            sp.NoiseProfile | Iterable[sp.NoiseProfile]
        ] = None,
        gate_replacement_policy: Optional[sp.GateReplacementPolicy] = None,
        batch_size=1024,
    ):
    ...
    def error_generator(
        self, code_data: stim.Circuit, seed: Optional[int] = None
    ) -> Iterator[StimErrorT]:
