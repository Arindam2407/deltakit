...
def _run_process(
    state_token: UUID, batch_limit: Optional[int], jobs: int, job_no: int
...
class NoiseModelDecoderManager(
    ...
    def _exec_shots_atomic(
        self, error_generator: Iterable[ErrorT], batch_limit: Optional[int]
    ):
    ...
    def _setup_and_run_process(
        self, batch_limit: Optional[int], jobs: int, job_no: int
    ) -> Tuple[EmpiricalDecodingErrorDistribution, List[BaseReporter]]:
    ...
    def _thread_worker(
        self, state_token, batch_limit: Optional[int], jobs: int, job_no: int
    ) -> Tuple[EmpiricalDecodingErrorDistribution, List[BaseReporter]]:
